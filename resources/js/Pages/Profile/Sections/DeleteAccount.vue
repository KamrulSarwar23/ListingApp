...
<template>
  <Container class="mb-6">
    <div class="mb-6">
      ...
      <p>
        Once your account is deleted, all ot its resources data will be
    ...
    <div v-if="showConfirmPassword">
      <form @submit.prevent="submit" class="flex items-end gap-4">
        ...
        <button
          ...
          class="text-indigo-500 font-medium underline dark:text-indigo-400 ml-3"
        >
          Cancel
        </button>
      </form>
    ...
    <button
      ...
      class="mt-3 px-6 py-2 rounded-lg bg-red-500 text-white"
    >
